...
You should check if the interpolation is done right with these figures. Also check if the inflections points for the EQE measurements are right. 
...
<img src="Figure18.jpg" width = "700">
